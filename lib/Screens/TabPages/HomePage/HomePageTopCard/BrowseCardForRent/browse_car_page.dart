import 'package:auto_haus_rental_app/Screens/TabPages/HomePage/HomePageTopCard/BookforWedding/browse_car_description.dart';
...
class _BrowseCarPageState extends State<BrowseCarPage> {
  BrowseCarsModel browseCarsModelObject = BrowseCarsModel();
  ...
  getBrowseCarsWidget() async {
    loadingP = true;
    setState(() {});
    try {
      String apiUrl = browseCarsApiUrl;
      ...
      if (response.statusCode == 200) {
        ...
        browseCarsModelObject = browseCarsModelFromJson(responseString);
        print(
            "browseCarsModelObjectLength: ${browseCarsModelObject.data!.length}");
      }
    } catch (e) {
  ...
  Widget browseCarsListWidget() {
    return SingleChildScrollView(
      child: loadingP
          ...
          : browseCarsModelObject.status != "success"
              ? const Center(
                  child: Text(
                    'no data found...',
              ...
              : Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount: browseCarsModelObject.data!.length,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      Text(
                                                          "${browseCarsModelObject.data![index].vehicalName} | ",
                                                          style: TextStyle(
                                                              color: kBlack,
                                                              fontSize: 14,
                                                              fontFamily:
                                                      ...
                                                      Text("MODEL ",
                                                          ...
                                                          textAlign:
                                                              TextAlign.left),
                                                      Text(
                                                          "${browseCarsModelObject.data![index].year} ",
                                                          style: TextStyle(
                                                            color: kBlack,
                                                            fontSize: 14,
                                                            fontFamily:
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Text(
                                                        "${browseCarsModelObject.data![index].carsDiscountRatePerYear}",
                                                        style: TextStyle(
                                                          color: kRed,
                                                          decoration:
                                                              TextDecoration
                                                      ...
                                                      Text(
                                                        "${browseCarsModelObject.data![index].carsDiscountRatePerMonth}",
                                                        style: TextStyle(
                                                          color: borderColor,
                                                          fontSize: 16,
                                                          fontFamily:
                                                      ...
                                                      Text(
                                                          "${browseCarsModelObject.data![index].rating}",
                                                          style: TextStyle(
                                                            color: kBlack,
                                                            fontSize: 12,
                                                            fontFamily:
                              ...
                              Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          "${browseCarsModelObject.data![index].discountPercentage}",
                                          style: TextStyle(
                                            color: kWhite,
                                            fontSize: 13,
                                ...
                                child: browseCarsModelObject
                                    ...
                                    : ClipRRect(
                                        ...
                                        child: FadeInImage(
                                          ...
                                          height: 150,
                                          image: NetworkImage(
                                              "$baseUrlImage${browseCarsModelObject.data![index].image1}"),
                                        ),
                                      ),
                              ),
                              Positioned(
