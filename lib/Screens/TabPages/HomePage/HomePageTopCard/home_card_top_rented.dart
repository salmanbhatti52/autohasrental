  ...
  getTopRentedCarsWidget() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            "topRenterCarName: ${topRentedCarsModelObject.data![0].vehicalName}");
        print(
            "topRenterCarPrice: ${topRentedCarsModelObject.data![0].carsPlans![0].pricePerMonth}");
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: loadingP
          ...
          : topRentedCarsModelObject.status != "success"
              ? const Center(
                  child: Text(
                    'no data found...',
...
List topRentedItemsList = [
  ToRentedItemsClass("assets/home_page/Rounded Rectangle 1 copy.png", "5%",
      'TESLA', "2022", " 9,000", "8,500"),
  ToRentedItemsClass("assets/home_page/Rounded Rectangle 3 copy.png", "5%",
      'TESLA', "2022", " 9,000", "8,500"),
  ToRentedItemsClass("assets/home_page/Rounded Rectangle 3 copy.png", "5%",
      'TESLA', "2022", " 9,000", "8,500"),
  ToRentedItemsClass("assets/home_page/Rounded Rectangle 4 copy.png", "5%",
      'TESLA', "2022", " 9,000", "8,500"),
  ToRentedItemsClass("assets/home_page/Rounded Rectangle 4 copy.png", "5%",
      'TESLA', "2022", " 9,000", "8,500"),
  ToRentedItemsClass("assets/home_page/Rounded Rectangle 4 copy.png", "5%",
...
class ToRentedItemsClass {
  ...
  ToRentedItemsClass(this.carImage, this.discountText, this.carCompanyName,
      this.carModelYear, this.oldPrice, this.newPrice);
}
