...
//
// class SearchDrivingBookingDetails extends StatefulWidget {
//   final String? selectedDay, startTime, endTime, selectedDate;
//   final SearchDatum? myDatum;
//   final double? slotPrice;
//
//   const SearchDrivingBookingDetails({Key? key, this.myDatum,
//     this.selectedDay, this.selectedDate, this.slotPrice,
//     this.startTime, this.endTime}) : super(key: key);
//
//   @override
//   State<SearchDrivingBookingDetails> createState() => _SearchDrivingBookingDetailsState();
// }
//
// class _SearchDrivingBookingDetailsState extends State<SearchDrivingBookingDetails> {
