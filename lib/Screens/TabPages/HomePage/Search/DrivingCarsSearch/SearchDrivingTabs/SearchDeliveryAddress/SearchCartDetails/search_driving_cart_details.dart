...
class SearchDrivingCartDetails extends StatefulWidget {
  final String? startTime, endTime, selectedDate;
  final SearchDatum? myDatum;
  final double? totalPrice, selectedSlotPrice;

   SearchDrivingCartDetails({Key? key, this.selectedDate, this.selectedSlotPrice,
    this.totalPrice, this.myDatum, this.startTime, this.endTime}) : super(key: key);

  @override
  State<SearchDrivingCartDetails> createState() => _SearchDrivingCartDetailsState();
}

class _SearchDrivingCartDetailsState extends State<SearchDrivingCartDetails> {
