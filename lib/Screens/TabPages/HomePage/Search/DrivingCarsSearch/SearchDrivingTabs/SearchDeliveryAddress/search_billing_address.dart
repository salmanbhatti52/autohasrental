...
import 'SearchCartDetails/search_driving_cart_details.dart';

class SearchBillingAddress extends StatefulWidget {
  final String? startTime, endTime, selectedDate;
  final double? totalPrice, selectedSlotPrice;
  final SearchDatum? myDatum;

  const SearchBillingAddress({Key? key, this.selectedDate, this.selectedSlotPrice,
    this.totalPrice, this.myDatum, this.startTime, this.endTime}) : super(key: key);

  @override
  State<SearchBillingAddress> createState() => _SearchBillingAddressState();
}

class _SearchBillingAddressState extends State<SearchBillingAddress> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(
                        builder: (context) => SearchDrivingCartDetails(
