...
// import 'SearchDrivingTabs/search_driving_desc_tabs.dart';
// import 'search_driving_booking_details.dart';
//
// class SearchDrivingBooking extends StatefulWidget {
//   final SearchDatum? searchDatum;
//   const SearchDrivingBooking({Key? key, this.searchDatum}) : super(key: key);
//
//   @override
//   State<SearchDrivingBooking> createState() => _SearchDrivingBookingState();
// }
//
// class _SearchDrivingBookingState extends State<SearchDrivingBooking> with SingleTickerProviderStateMixin {
...
//     companyImage = "$baseUrlImage${widget.searchDatum!.usersCompanies!.companyLogo}";
//     companyName = widget.searchDatum!.usersCompanies!.companyName;
//     companyId = "${widget.searchDatum!.usersCompaniesId}";
...
//     for(int i = 0; i<widget.searchDatum!.carsPlans!.length; i++){
//       DateTime date = DateTime.parse("${widget.searchDatum!.carsPlans![i].planDate}");
...
//
//     if(matchDate != null){
//       for(int k = 0; k<widget.searchDatum!.carsPlans!.length; k++) {
//         DateTime date = DateTime.parse("${widget.searchDatum!.carsPlans![k].planDate}");
//         formattedDate = DateFormat("yyyy-MM-dd").format(date);
//         if(formattedDate == matchDate ){
//           myCarPlan.add(CustomSlotModel(
//             date: widget.searchDatum!.carsPlans![k].planDate.toString(),
//             startTime: "${widget.searchDatum!.carsPlans![k].startTime}",
//             endTime: "${widget.searchDatum!.carsPlans![k].endTime}",
//             discountedPrice: widget.searchDatum!.carsPlans![k].discountedPricePerSlot.toString(),
//           ));
...
//     myCurrentCarIndex = widget.searchDatum!.carsId;
//     getToday();
//     super.initState();
//   }
//
...
//                 children: [
//                   Text("${widget.searchDatum!.vehicalName}, ", style: TextStyle(fontSize: 16, fontFamily: poppinBold, color: kWhite),),
//                   Text("${widget.searchDatum!.year}", style: TextStyle(fontSize: 16, fontFamily: poppinRegular, color: kWhite),),
//                 ]),
//           )),
...
//                           child: Image.network("$baseUrlImage${widget.searchDatum!.carsMakes!.image}",
...
//                           child: widget.searchDatum!.favouriteStatus == "like"?
...
//                       children: [
//                         Positioned(
//                           child: Image.network("$baseUrlImage${widget.searchDatum!.image1}",
...
//                             ),
//                             Text(
//                               "${widget.searchDatum!.carsPlans![0].discountedPricePerSlot}",
...
//
//             SizedBox(height: MediaQuery.of(context).size.height * 0.02),
//             SearchDrivingDescTabs(
//               searchDatum: widget.searchDatum,
//             ),
//             GestureDetector(
//                 onTap: () {
