...
class _FavoritePageState extends State<FavoritePage> {
  ...
  LikeUnlikeFavoriteCarModel likeUnlikeFavoriteCarModel =
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseString != 'false') {
          likeUnlikeFavoriteCarModel =
              likeUnlikeFavoriteCarModelFromJson(responseString);
          setState(() {});
          print(
              'likeUnlikeFavoriteCarModel status: ${likeUnlikeFavoriteCarModel.status}');
        }
      }
    } catch (e) {
