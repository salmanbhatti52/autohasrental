...
//
// class RebookDrivingDetailsPage extends StatefulWidget {
//   final String? selectedDay, startTime, endTime, selectedDate;
//   final DatumDrivingPrevious? myDatum;
//   final double? slotPrice;
//
//   const RebookDrivingDetailsPage({Key? key, this.myDatum,
//     this.selectedDay, this.selectedDate, this.slotPrice,
//     this.startTime, this.endTime}) : super(key: key);
//
//   @override
//   State<RebookDrivingDetailsPage> createState() => _RebookDrivingDetailsPageState();
// }
//
// class _RebookDrivingDetailsPageState extends State<RebookDrivingDetailsPage> {
...
//         Positioned(
//           left: 50, right: 40,
//           child: Image.network("$baseUrlImage${widget.myDatum!.carsDetails!.image1}", height: 140, ),
//         ),
//         Positioned(
//             top: 28, left: 27,
//             child: Container(
...
//                 mainAxisAlignment: MainAxisAlignment.center,
//                 children: [
//                   Text("${widget.myDatum!.carsDetails!.discountPercentage}% ",
//                       textAlign: TextAlign.left, style: TextStyle(
