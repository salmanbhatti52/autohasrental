...
//
// class RebookCheckOutPage extends StatefulWidget {
...
//
//   RebookCheckOutPage({Key? key, this.selectedDate, this.selectedSlotPrice,
...
//
//   @override
//   State<RebookCheckOutPage> createState() => _RebookCheckOutPageState();
// }
//
// class _RebookCheckOutPageState extends State<RebookCheckOutPage> {
...
//     print("pricePerSlot: ${widget.myDatum!.carsPlans![0].pricePerSlot}");
//     print("carDiscountPercentage: ${widget.myDatum!.carsDetails!.discountPercentage}");
...
//     request.fields['price_per_slot'] = "${widget.myDatum!.carsPlans![0].pricePerSlot}";
//     request.fields['discount_percentage'] = "${widget.myDatum!.carsDetails!.discountPercentage}";
...
//     print('totalCost: ${widget.totalPrice}');
//     print('pricePerHour: ${widget.myDatum!.carsPlans![0].pricePerSlot}');
//     print('discountPercentage: ${widget.myDatum!.carsDetails!.discountPercentage}');
//     print("homeAddress: ${widget.homeAddress1} ${widget.homeAddress2}");
//     print("addressAvailableStatus $addressAvailableStatus");
//     print("homePostCity: ${widget.homeCity} ${widget.homePostCode}");
//     print("homeState: ${widget.homeState} ${widget.homeCountry}");
...
//                                 Row(
//                                   children: [
//                                     Text("${widget.myDatum!.carsDetails!.vehicalName} ", textAlign: TextAlign.left,
//                                       style: TextStyle(color: kBlack,
//                                         fontSize: 14, fontFamily: poppinBold)),
//                                     Text("${widget.myDatum!.carsDetails!.carsColors!.name}", textAlign: TextAlign.left,
//                                         style: TextStyle(color: kBlack,
...
//                                 Row(
//                                   children: [
//                                     Text("${widget.myDatum!.carsDetails!.carsMakes} ", textAlign: TextAlign.left,
//                                       style: TextStyle(color: kBlack,
//                                         fontSize: 12, fontFamily: poppinRegular)),
//                                     Text("${widget.myDatum!.carsDetails!.carsModels} ", textAlign: TextAlign.left,
//                                         style: TextStyle(color: kBlack,
//                                             fontSize: 14, fontFamily: poppinMedium)),
//                                     Text("${widget.myDatum!.carsDetails!.year}", textAlign: TextAlign.left,
//                                         style: TextStyle(color: kBlack,
//                                             fontSize: 10, fontFamily: poppinRegular)),
//                                   ],
//                                 ),
...
//                                         showRatingStars(double.parse("${widget.myDatum!.carsDetails!.rating}")),
//                                         SizedBox(
//                                           width: MediaQuery.of(context).size.height * 0.01),
//
//                                         widget.myDatum!.carsDetails!.rating == null?
//                                         Text("0.0", textAlign: TextAlign.left,
//                                           style: TextStyle(color: kBlack,
//                                               fontSize: 12, fontFamily: poppinRegular)):
//                                         Text("${widget.myDatum!.carsDetails!.rating}", textAlign: TextAlign.left,
//                                             style: TextStyle(color: kBlack,
//                                                 fontSize: 12, fontFamily: poppinRegular))
//                                       ],
//                                     ),
...
//                       top: 35,
//                       left: 50, right: 50,
//                       child: Image.network("$baseUrlImage${widget.myDatum!.carsDetails!.image1}",
//                           // fit: BoxFit.fill,
//                         width: 350,
//                         height: 130,),
//                     ),
...
//                             mainAxisAlignment: MainAxisAlignment.center,
//                             children: [
//                               Text("${widget.myDatum!.carsDetails!.discountPercentage}% ", textAlign: TextAlign.left,
//                                 style: TextStyle(color: kWhite,
