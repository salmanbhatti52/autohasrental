...
//   final DatumDrivingPrevious? datumPreviousDriving;
//
//   DrivingBookingDetail({super.key, this.datumPreviousDriving});
//
//   @override
...
//     print('userId in getRateCarApi $userId ${widget.datumPreviousDriving!.carsId}');
//
//     // try {
...
//       "cars_id": widget.datumPreviousDriving!.carsId,
//     });
...
//                                     Row(
//                                       children: [
//                                         Text("${widget.datumPreviousDriving!.carsDetails!.vehicalName} ",
//                                             textAlign: TextAlign.left, style: TextStyle(
//                                                 color: kBlack, fontSize: 14, fontFamily: poppinBold)),
//                                         Text("${widget.datumPreviousDriving!.carsDetails!.carsColors!.name}",
//                                             textAlign: TextAlign.left, style: TextStyle(
...
//                                       children: [
//
//                                         Text("${widget.datumPreviousDriving!.carsDetails!.carsModels} ",
//                                             textAlign: TextAlign.left, style: TextStyle(
//                                                 color: kBlack, fontSize: 12, fontFamily: poppinRegular)),
//                                         Text("${widget.datumPreviousDriving!.carsDetails!.carsMakes} ",
//                                             textAlign: TextAlign.left, style: TextStyle(
//                                                 color: kBlack, fontSize: 14, fontFamily: poppinMedium)),
//                                         Text("${widget.datumPreviousDriving!.carsDetails!.year} ",
//                                             textAlign: TextAlign.left, style: TextStyle(
//                                                 color: kBlack, fontSize: 12, fontFamily: poppinRegular)),
//                                       ],
//                                     ),
...
//                                         ),
//                                         Text("${widget.datumPreviousDriving!.carsPlans![0].pricePerSlot}",
//                                             textAlign: TextAlign.left, style: TextStyle(
...
//                                         showRatingStars(double.parse("${widget.datumPreviousDriving!.carsDetails!.rating}")),
//                                         SizedBox(width: MediaQuery.of(context).size.height * 0.01),
//
//                                         widget.datumPreviousDriving!.carsDetails!.rating == null?
//                                         Text("0.0", textAlign: TextAlign.left,
//                                             style: TextStyle(color: kBlack,
//                                                 fontSize: 12, fontFamily: poppinRegular)):
//                                         Text("${widget.datumPreviousDriving!.carsDetails!.rating}",
//                                             textAlign: TextAlign.left, style: TextStyle(
//                                                 color: kBlack, fontSize: 12, fontFamily: poppinRegular)),
//                                       ],
//                                     ),
...
//                       imageUrl: "$baseUrlImage${widget.datumPreviousDriving!.carsDetails!.image1}",
...
//                         children: [
//                           Text("${widget.datumPreviousDriving!.carsDetails!.discountPercentage}",
...
//               datumP: widget.datumPreviousDriving,
//             ),
//             GestureDetector(
//                 onTap: () {
//
...
//     print("userId carId: $userId ${widget.datumPreviousDriving!.carsId}");
