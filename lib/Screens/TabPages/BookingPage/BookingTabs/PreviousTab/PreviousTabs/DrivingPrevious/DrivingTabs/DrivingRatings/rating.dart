...
class DrivingRatingDetails extends StatefulWidget {
  final String? userRating, userComment;
  const DrivingRatingDetails({super.key, this.userComment, this.userRating});

  @override
  State<DrivingRatingDetails> createState() => _DrivingRatingDetailsState();
}

class _DrivingRatingDetailsState extends State<DrivingRatingDetails> {
