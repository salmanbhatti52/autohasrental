...
// import 'rebook_billing_address.dart';
//
// class RebookAddressTabBars extends StatefulWidget {
//   final String? startTime, endTime, selectedDate;
//   final double? totalPrice, selectedSlotPrice;
//   final DatumDrivingPrevious? myDatum;
//
//   const RebookAddressTabBars({Key? key, this.selectedDate,
//     this.totalPrice, this.selectedSlotPrice,
//     this.myDatum, this.startTime, this.endTime}): super(key: key);
//
//   @override
//   State<RebookAddressTabBars> createState() => _RebookAddressTabBarsState();
// }
//
// abstract class TickerProvider {}
//
// class _RebookAddressTabBarsState extends State<RebookAddressTabBars> with SingleTickerProviderStateMixin {
//
//   mySelectedData(){
