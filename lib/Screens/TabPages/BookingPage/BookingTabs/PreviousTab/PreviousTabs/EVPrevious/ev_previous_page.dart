...
class _EvPreviousPageState extends State<EvPreviousPage> {
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) => EVCarDescription(
                carImageModel: carDetailsByIdModelObject.data?.objectImage,
                    ...
                    carColorName:
                        carDetailsByIdModelObject.data!.carsColors!.name,
                    carMakesName:
                        carDetailsByIdModelObject.data!.carsMakes!.name,
                    carModelName:
                        carDetailsByIdModelObject.data!.carsModels!.name,
                    carImage: carDetailsByIdModelObject.data!.image1!
                                .endsWith('.jpg') ||
                        ...
                        : carDetailsByIdModelObject.data?.image1,
                    carMakesImage:
                        "$baseUrlImage${carDetailsByIdModelObject.data!.carsMakes!.image}",
                    favouriteStatus: carDetailsByIdModelObject.data!.status,
                    discountPercentage:
                        carDetailsByIdModelObject.data!.discountPercentage,
                    carDiscountPrice:
                        "${carDetailsByIdModelObject.data!.carsPlans![0].discountedPricePerMonth}",
                    carPrice: carDetailsByIdModelObject
                        .data!.carsPlans![0].pricePerMonth,
                    carOwnerImage:
                        "$baseUrlImage${carDetailsByIdModelObject.data!.usersCompanies!.companyLogo}",
                    carOwnerName:
                        "${carDetailsByIdModelObject.data!.usersCompanies!.companyName}",
                    carOwnerId: carDetailsByIdModelObject
                        .data!.usersCompanies!.usersCompaniesId,
                    myCarDescription:
                        carDetailsByIdModelObject.data!.description,
                  )));
      // });
    }
    // } catch (e) {
  ...
  Widget build(BuildContext context) {
    return loadingP
        ...
        : evPreviousObject.data?[0].carsDetails?.carsUsageType ==
                "EV Subscriptions"
            ? Padding(
                  ...
                  child: Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          int reversedindex =
                              evPreviousObject.data!.length - 1 - index;
                          String priceString = evPreviousObject
                              .data![reversedindex].carsPlans![0].pricePerMonth
                              .toString();
                              ...
                              children: [
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  "${evPreviousObject.data![reversedindex].carsDetails!.vehicalName}",
                                                  style: TextStyle(
                                                    color: kBlack,
                                                    fontSize: 14,
                                                ...
                                                Text(
                                                  "${evPreviousObject.data![reversedindex].carsDetails!.year}",
                                                  style: TextStyle(
                                ...
                                Positioned(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      carID = evPreviousObject
                                          .data![reversedindex]
                                          .carsId;
                                      print(
                                          "photoPreviousObject $carID");
                                ...
                                Positioned(
                                  left: 20,
                                  bottom: 70,
                                  child: evPreviousObject.data![reversedindex].status == "Completed"
                                    ? Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Text(
                                              '${evPreviousObject.data![reversedindex].status}',
                                              textAlign:
                                              TextAlign
                                                  .center,
                                              style: TextStyle(
