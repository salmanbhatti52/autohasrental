...
//
//                   // return previousBookingModelObject.data?[index].carsDetails!.carsUsageType == "DrivingPrevious Experience" ?
//                   return Stack(
//                     children: [
//                       Padding(
...
//                                               ),
//                                               Text("${previousBookingModelObject.data![index].carsPlans![0].pricePerMonth}", textAlign: TextAlign.left, style: TextStyle(
