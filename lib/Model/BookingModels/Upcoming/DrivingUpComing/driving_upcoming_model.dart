// import 'dart:convert';
//
// DrivingUpcomingModel drivingUpcomingModelFromJson(String str) => DrivingUpcomingModel.fromJson(json.decode(str));
//
// String drivingUpcomingModelToJson(DrivingUpcomingModel data) => json.encode(data.toJson());
//
// class DrivingUpcomingModel {
//   DrivingUpcomingModel({
//     this.status,
//     this.data,
//   });
//
//   String? status;
//   List<DrivingDatum>? data;
//
//   factory DrivingUpcomingModel.fromJson(Map<String, dynamic> json) => DrivingUpcomingModel(
//     status: json["status"],
//     data: json["data"] != null ? List<DrivingDatum>.from(json["data"].map((x) => DrivingDatum.fromJson(x))): null,
//   );
//
...
//   int? carsPlansCount;
//
//   factory DrivingDatum.fromJson(Map<String, dynamic> json) => DrivingDatum(
