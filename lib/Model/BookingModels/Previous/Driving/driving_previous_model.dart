...
// import 'dart:convert';
//
// DrivingPreviousModel drivingPreviousModelFromJson(String str) => DrivingPreviousModel.fromJson(json.decode(str));
//
// String drivingPreviousModelToJson(DrivingPreviousModel data) => json.encode(data.toJson());
//
// class DrivingPreviousModel {
//   DrivingPreviousModel({
//     this.status,
//     this.data,
//   });
//
...
class DrivingPreviousModel {
  DrivingPreviousModel({this.status, this.data});
