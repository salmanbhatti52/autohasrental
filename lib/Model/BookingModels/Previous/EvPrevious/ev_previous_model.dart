...
// import 'dart:convert';
//
// EvPreviousModel evPreviousModelFromJson(String str) => EvPreviousModel.fromJson(json.decode(str));
//
...
//   int? carsPlansCount;
//
//   factory DatumPreviousEv.fromJson(Map<String, dynamic> json) => DatumPreviousEv(
