...
NotificationsUnReadModel notificationsUnReadModelFromJson(String str) => NotificationsUnReadModel.fromJson(json.decode(str));

String notificationsUnReadModelToJson(NotificationsUnReadModel data) => json.encode(data.toJson());
...
class NotificationsUnReadModel {
  ...
  factory NotificationsUnReadModel.fromJson(Map<String, dynamic> json) => NotificationsUnReadModel(
    status: json["status"],
