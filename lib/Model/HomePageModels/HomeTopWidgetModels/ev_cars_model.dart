...
// import 'dart:convert';
//
// EvCarsModel evSubscriptionCarsModelFromJson(String str) => EvCarsModel.fromJson(json.decode(str));
//
// String evSubscriptionCarsModelToJson(EvCarsModel data) => json.encode(data.toJson());
//
// class EvCarsModel {
//   EvCarsModel({
//     this.status,
...
//   List<Datum>? data;
//
//   factory EvCarsModel.fromJson(Map<String, dynamic> json) => EvCarsModel(
//     status: json["status"],
...
//   double? discountedPricePerMonth;
//
...
//     discountedPricePerMonth: json["discounted_price_per_month"]?.toDouble(),
//   );
//
//   Map<String, dynamic> toJson() => {
...
EvCarsModel evCarsModelFromJson(String str) => EvCarsModel.fromJson(json.decode(str));

String evCarsModelToJson(EvCarsModel data) => json.encode(data.toJson());

class EvCarsModel {
  EvCarsModel({this.status, this.data});

  String? status;
  List<DatumEvTopCard>? data;

  factory EvCarsModel.fromJson(Map<String, dynamic> json) => EvCarsModel(
    status: json["status"],
    data: json["data"] != null ? List<DatumEvTopCard>.from(json["data"].map((x) => DatumEvTopCard.fromJson(x))): null,
  );
...
class DatumEvTopCard {
  ...
  factory DatumEvTopCard.fromJson(Map<String, dynamic> json) => DatumEvTopCard(
    carsId: json["cars_id"],
    usersCompaniesId: json["users_companies_id"],
    vehicalName: json["vehical_name"],
    licensePlate: json["license_plate"],
