...
PhotoGraphyModel photoGraphyModelFromJson(String str) =>
    PhotoGraphyModel.fromJson(json.decode(str));

String photoGraphyModelToJson(PhotoGraphyModel data) =>
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        carsPlans: List<CarsPlan>.from(
            json["cars_plans"].map((x) => CarsPlan.fromJson(x))),
      );
...
// class PhotoGraphyModel {
//   PhotoGraphyModel({this.status, this.data});
...
//     status: json["status"],
//     data: json["data"] != null ? List<DatumPhotography>.from(json["data"].map((x) => DatumPhotography.fromJson(x))): null,
//   );
