...
DrivingCarDetailsByIdModel drivingCarDetailsByIdModelFromJson(String str) => DrivingCarDetailsByIdModel.fromJson(json.decode(str));

String drivingCarDetailsByIdModelToJson(DrivingCarDetailsByIdModel data) => json.encode(data.toJson());

class DrivingCarDetailsByIdModel {
  DrivingCarDetailsByIdModel({
    this.status,
    this.data,
  });
  ...
  factory DrivingCarDetailsByIdModel.fromJson(Map<String, dynamic> json) => DrivingCarDetailsByIdModel(
    status: json["status"],
    data: DatumBooking.fromJson(json["data"]),
  );
...
class DatumBooking {
  ...
  factory DatumBooking.fromJson(Map<String, dynamic> json) => DatumBooking(
    carsId: json["cars_id"],
