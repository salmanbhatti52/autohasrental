...
CarDetailsByIdModel carDetailsByIdModelFromJson(String str) => CarDetailsByIdModel.fromJson(json.decode(str));

String carDetailsByIdModelToJson(CarDetailsByIdModel data) => json.encode(data.toJson());

class CarDetailsByIdModel {
  CarDetailsByIdModel({
    this.status,
    this.data,
  });
  ...
  factory CarDetailsByIdModel.fromJson(Map<String, dynamic> json) => CarDetailsByIdModel(
    status: json["status"],
